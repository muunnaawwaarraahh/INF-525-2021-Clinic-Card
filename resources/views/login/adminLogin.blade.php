          ...
          <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 infinity-form">
            ...
            <form class="px-3" action="/admin/check" method="post">
              ...
              <div class="form-input">
                ...
                <input type="text" name="username" id="username" placeholder="Username" tabindex="10" value="{{ old('username') }}" required />
              </div>
              <div class="form-input">
              ...
              <div class="text-center mb-5" style="color: #777">
                {{-- Belum punya akun?
                <a class="register-link" href="/register">Daftar disini!</a>
                <br /> --}}
